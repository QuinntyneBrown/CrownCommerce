...
public sealed class SystemPromptBuilder
{
    ...
    public string Build()
    {
        ...
        sb.AppendLine("You are a friendly, knowledgeable assistant for Origin Hair Collective â€” a premium hair extension and hair product company.");
        sb.AppendLine();
        ...
        sb.AppendLine("- Keep responses concise but helpful â€” aim for 2-4 sentences unless more detail is needed.");
        sb.AppendLine();
