...
@Component({
  ...
  template: `
    <section class="content-page">
      <lib-section-header label="OUR STORY" heading="About Origin Hair Collective" />
      @if (body()) {
...
export class AboutPage implements OnInit {
  ...
  ngOnInit(): void {
    this.contentService.getPage('our-story').subscribe({
      next: (page) => this.body.set(page.body),
      error: () => this.body.set('<p>Our story content is currently unavailable.</p>'),
    });
  }
}
