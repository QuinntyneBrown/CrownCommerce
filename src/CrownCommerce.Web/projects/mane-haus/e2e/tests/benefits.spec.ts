...
test.describe('Benefits Section', () => {
  ...
  test('should display Community First benefit card', async () => {
    ...
    expect(card.description).toContain("More than a brand");
  });
