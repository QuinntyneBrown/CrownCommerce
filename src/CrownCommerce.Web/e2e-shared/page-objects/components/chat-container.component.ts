...
export class ChatContainerPOM {
  ...
  async getMessageTexts(): Promise<string[]> {
    return this.messageThread.locator('lib-chat-message .message__text').allTextContents();
  }
  ...
  async getMessageTimestamps(): Promise<string[]> {
    return this.messageThread.locator('lib-chat-message .message__time').allTextContents();
  }
