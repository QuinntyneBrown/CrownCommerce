...
| 03 | [Authentication & Authorization](03-authentication-authorization/README.md) | Draft | Custom JWT authentication via jose with httpOnly cookies, bcrypt password hashing, three-role RBAC (customer/admin/team), middleware and guard-based route protection covering L2-008, L2-009, L2-055, L2-056 |
